...
//0: all 1: error only 2:error+warning 3:none
function ru() {
    var s = [];
    var war = false;
    for (var x in m.xyz) {
        ...
        war = val > warning_lower && val < warning_upper ? true : war
